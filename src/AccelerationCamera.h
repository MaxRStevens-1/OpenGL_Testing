 ...
 public:
     ...
     glm::mat4 getBehindView() {
        return cameraLookAtBehind(camera_pos, camera_pos + camera_front, camera_up);
     }
 
     glm::mat4 cameraLookAtBehind(glm::vec3 pos, glm::vec3 forward, glm::vec3 up) {
        glm::mat4 orientationMatrix = glm::mat4(1.0f);
         
        glm::vec3 zaxis = glm::normalize(pos - forward) * -1.0f;
