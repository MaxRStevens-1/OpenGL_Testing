...
int main()
{
    ...
    // in order 2 work w/ skybox, we need to set this LEQUAL
    glDepthFunc(GL_LEQUAL); // always pass the depth test (same effect as glDisable(GL_DEPTH_TEST))

    // build and compile shaders
    // -------------------------
    
    Shader shader("env_mapping_cubemap");
    Shader floor_shader("depth_testing");
    ...
    while(!glfwWindowShouldClose(window))
    {
        ...
        shader.setVec3("camera_pos", camera.camera_pos);
        // cubes
        glBindVertexArray(cubeVAO);
        ...
        floor_shader.setMat4("model", glm::mat4(1.0f));
